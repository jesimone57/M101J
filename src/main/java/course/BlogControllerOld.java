...
public class BlogControllerOld {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length == 0) {
            new BlogControllerOld("mongodb://localhost");
        }
        else {
            new BlogControllerOld(args[0]);
        }
    }

    public BlogControllerOld(String mongoURIString) throws IOException {
    ...
    private Configuration createFreemarkerConfiguration() {
        ...
        retVal.setClassForTemplateLoading(BlogControllerOld.class, "/freemarker");
        return retVal;
    }
}
